...
function mapExpenseFromApi(e) {
  ...
  const dueStr = due ? String(due).split("T")[0] : "";
  return {
    id: e.id,
    title: e.title,
    ...
    categoryId: e.category_id ?? e.category?.id,
    personId: e.person_id ?? e.person?.id,
    location: e.location ?? "",
...
function buildExpensePayload(form) {
  return {
    ...
    current_installment: form.currentInstallment,
...
const INIT_PEOPLE = ["João", "Maria", "Pedro", "Ana"];

const INITIAL_CATEGORIES = CATEGORIES.map((c, i) => ({ ...c, id: i + 1 }));
const INITIAL_PEOPLE = INIT_PEOPLE.map((name, i) => ({ id: i + 1, name }));

const INIT_EXPENSES = [
  { id:1,  title:"Supermercado",      amount:420.80,  category:"Alimentação", person:"João",  location:"Carrefour",         paymentMethod:"pix",         paymentMonth:"2026-03", dueDate:"2026-03-31", installments:1, currentInstallment:1, notes:"",                  status:"pending" },
  { id:2,  title:"Conta de Luz",      amount:187.50,  category:"Moradia",     person:"Maria", location:"CEMIG",             paymentMethod:"pix",         paymentMonth:"2026-03", dueDate:"2026-04-02", installments:1, currentInstallment:1, notes:"",                  status:"pending" },
  { id:3,  title:"Netflix",           amount:55.90,   category:"Lazer",       person:"João",  location:"Netflix",           paymentMethod:"credit_card", paymentMonth:"2026-03", dueDate:"2026-04-05", installments:1, currentInstallment:1, notes:"",                  status:"pending" },
  { id:4,  title:"Gasolina",          amount:250.00,  category:"Transporte",  person:"Pedro", location:"Posto Shell",       paymentMethod:"debit",       paymentMonth:"2026-03", dueDate:"2026-03-28", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:5,  title:"Academia",          amount:120.00,  category:"Saúde",       person:"Ana",   location:"Smart Fit",         paymentMethod:"debit",       paymentMonth:"2026-03", dueDate:"2026-03-20", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:6,  title:"Aluguel",           amount:1800.00, category:"Moradia",     person:"João",  location:"Imobiliária ABC",   paymentMethod:"transfer",    paymentMonth:"2026-03", dueDate:"2026-03-10", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:7,  title:"Restaurante",       amount:185.60,  category:"Alimentação", person:"Maria", location:"Restaurante Chef",  paymentMethod:"credit_card", paymentMonth:"2026-03", dueDate:"2026-04-10", installments:1, currentInstallment:1, notes:"Jantar especial",   status:"pending" },
  { id:8,  title:"Farmácia",          amount:89.30,   category:"Saúde",       person:"Ana",   location:"Drogasil",          paymentMethod:"cash",        paymentMonth:"2026-02", dueDate:"2026-02-15", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:9,  title:"Conta de Internet", amount:99.90,   category:"Moradia",     person:"João",  location:"Claro",             paymentMethod:"pix",         paymentMonth:"2026-02", dueDate:"2026-02-20", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:10, title:"Curso Online",      amount:297.00,  category:"Educação",    person:"Pedro", location:"Udemy",             paymentMethod:"credit_card", paymentMonth:"2026-02", dueDate:"2026-02-28", installments:3, currentInstallment:1, notes:"Curso de React",    status:"paid"    },
  { id:11, title:"Passagem Aérea",    amount:850.00,  category:"Transporte",  person:"Maria", location:"GOL Airlines",      paymentMethod:"credit_card", paymentMonth:"2026-04", dueDate:"2026-04-15", installments:2, currentInstallment:1, notes:"Viagem negócios",   status:"pending" },
  { id:12, title:"Fatura Cartão",     amount:2150.00, category:"Outros",      person:"João",  location:"Nubank",            paymentMethod:"transfer",    paymentMonth:"2026-03", dueDate:"2026-03-25", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:13, title:"Plano de Saúde",    amount:465.00,  category:"Saúde",       person:"Ana",   location:"Unimed",            paymentMethod:"debit",       paymentMonth:"2026-03", dueDate:"2026-03-05", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:14, title:"Supermercado",      amount:380.20,  category:"Alimentação", person:"Maria", location:"Pão de Açúcar",     paymentMethod:"debit",       paymentMonth:"2026-02", dueDate:"2026-02-10", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:15, title:"IPTU Parcela",      amount:320.00,  category:"Moradia",     person:"João",  location:"Prefeitura",        paymentMethod:"pix",         paymentMonth:"2026-02", dueDate:"2026-02-05", installments:12, currentInstallment:2, notes:"",                 status:"paid"    },
  { id:16, title:"Livros",            amount:145.00,  category:"Educação",    person:"Pedro", location:"Amazon",            paymentMethod:"credit_card", paymentMonth:"2026-01", dueDate:"2026-01-20", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:17, title:"Combustível",       amount:200.00,  category:"Transporte",  person:"Pedro", location:"Posto Ipiranga",    paymentMethod:"debit",       paymentMonth:"2026-01", dueDate:"2026-01-15", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:18, title:"Conta de Água",     amount:95.00,   category:"Moradia",     person:"João",  location:"SABESP",            paymentMethod:"pix",         paymentMonth:"2026-02", dueDate:"2026-02-28", installments:1, currentInstallment:1, notes:"",                  status:"overdue" },
  { id:19, title:"Spotify",           amount:21.90,   category:"Lazer",       person:"Ana",   location:"Spotify",           paymentMethod:"credit_card", paymentMonth:"2026-04", dueDate:"2026-04-03", installments:1, currentInstallment:1, notes:"",                  status:"pending" },
  { id:20, title:"Manutenção Carro",  amount:650.00,  category:"Transporte",  person:"Pedro", location:"Auto Center",       paymentMethod:"pix",         paymentMonth:"2026-04", dueDate:"2026-04-07", installments:1, currentInstallment:1, notes:"Revisão semestral", status:"pending" },
  { id:21, title:"Roupas",            amount:280.00,  category:"Roupas",      person:"Maria", location:"Zara",              paymentMethod:"credit_card", paymentMonth:"2026-01", dueDate:"2026-01-25", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:22, title:"Aluguel",           amount:1800.00, category:"Moradia",     person:"João",  location:"Imobiliária ABC",   paymentMethod:"transfer",    paymentMonth:"2026-02", dueDate:"2026-02-10", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:23, title:"Aluguel",           amount:1800.00, category:"Moradia",     person:"João",  location:"Imobiliária ABC",   paymentMethod:"transfer",    paymentMonth:"2026-01", dueDate:"2026-01-10", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
  { id:24, title:"Supermercado",      amount:390.00,  category:"Alimentação", person:"João",  location:"Extra",             paymentMethod:"pix",         paymentMonth:"2026-01", dueDate:"2026-01-12", installments:1, currentInstallment:1, notes:"",                  status:"paid"    },
];

const INIT_EXPENSES_SEED = INIT_EXPENSES.map((row) => ({
  ...row,
  categoryId: INITIAL_CATEGORIES.find((c) => c.name === row.category)?.id,
  personId: INITIAL_PEOPLE.find((p) => p.name === row.person)?.id,
}));

// ─── HELPERS ──────────────────────────────────────────────────────────────────
const fmt = (v) => new Intl.NumberFormat("pt-BR", { style: "currency", currency: "BRL" }).format(v);
const fmtDate = (d) => { if (!d) return "—"; const [y,m,day] = d.split("-"); return `${day}/${m}/${y}`; };
const TODAY = "2026-03-31"; // fixed demo date
const getDays = (dueDate) => {
  const t = new Date(TODAY + "T00:00:00"), d = new Date(dueDate + "T00:00:00");
  return Math.floor((d - t) / 86400000);
};
const getCat  = (name) => CATEGORIES.find(c => c.name === name) || CATEGORIES[8];
const getPM   = (v)    => PAY_METHODS.find(m => m.v === v) || PAY_METHODS[0];

// ─── SIDEBAR ──────────────────────────────────────────────────────────────────
const Sidebar = ({ view, setView, alertCount }) => {
  const nav = [
...
// ─── EXPENSE MODAL ────────────────────────────────────────────────────────────
function defaultExpenseForm(expense, categories, people) {
  if (expense) {
    return {
      id: expense.id,
      title: expense.title,
      amount: expense.amount,
      categoryId: expense.categoryId ?? categories.find((c) => c.name === expense.category)?.id ?? categories[0]?.id,
      personId: expense.personId ?? people.find((p) => p.name === expense.person)?.id ?? people[0]?.id,
...
const ExpenseModal = ({ expense, categories, people, onSave, onClose }) => {
  const [form, setForm] = useState(() => defaultExpenseForm(expense, categories, people));
  const set = (k, v) => setForm((f) => ({ ...f, [k]: v }));

  const handleSave = () => {
    if (!form.title.trim() || form.amount === "" || form.amount == null) return alert("Preencha descrição e valor.");
    const cat = categories.find((c) => c.id === form.categoryId);
    const per = people.find((p) => p.id === form.personId);
    onSave({
      ...form,
      amount: parseFloat(form.amount),
      category: cat?.name ?? "",
        ...
        <div style={{ padding:"20px 24px" }}>
          ...
          <div style={{ ...row, gridTemplateColumns:"1fr 1fr" }}>
            <div>
              ...
              <input type="number" style={inp} value={form.amount === undefined || form.amount === null ? "" : form.amount} onChange={(e) => set("amount", e.target.value)} placeholder="0,00" min="0" step="0.01" />
            </div>
            <div>
          ...
          <div style={{ ...row, gridTemplateColumns:"1fr 1fr" }}>
            <div>
              ...
              <select style={inp} value={form.categoryId ?? ""} onChange={(e) => set("categoryId", Number(e.target.value))}>
                {categories.map((c) => (
                  <option key={c.id ?? c.name} value={c.id ?? c.name}>{c.icon} {c.name}</option>
                ))}
              </select>
            </div>
            <div>
              <label style={lbl}>Quem fez o gasto</label>
              <select style={inp} value={form.personId ?? ""} onChange={(e) => set("personId", Number(e.target.value))}>
                {people.map((p) => {
                  const id = p.id ?? p;
                  const name = p.name ?? p;
                  return (
...
// ─── DASHBOARD VIEW ───────────────────────────────────────────────────────────
const DashboardView = ({ expenses, categories, onAdd, onEdit, onMarkPaid }) => {
  const CUR = "2026-03";
  const me = expenses.filter(e => e.paymentMonth === CUR);
  const total   = me.reduce((s,e) => s + e.amount, 0);
  const paid    = me.filter(e => e.status==="paid").reduce((s,e) => s + e.amount, 0);
  const pending = me.filter(e => e.status!=="paid").reduce((s,e) => s + e.amount, 0);

  const monthlyData = ["2026-01","2026-02","2026-03","2026-04"].map(m => ({
    name: MONTHS[parseInt(m.split("-")[1])-1],
    Total: +expenses.filter(e => e.paymentMonth===m).reduce((s,e) => s+e.amount,0).toFixed(0),
    Pago:  +expenses.filter(e => e.paymentMonth===m && e.status==="paid").reduce((s,e) => s+e.amount,0).toFixed(0),
  }));

  const catData = categories.map(c => ({
    name: c.name, value: +me.filter(e => e.category===c.name).reduce((s,e)=>s+e.amount,0).toFixed(2), color: c.color,
  })).filter(c => c.value > 0).sort((a,b) => b.value - a.value);

  const alertList = expenses.filter(e => e.status!=="paid" && getDays(e.dueDate)<=7).sort((a,b) => getDays(a.dueDate)-getDays(b.dueDate)).slice(0,6);

  const card = (bg, border) => ({ padding:"10px 14px", borderRadius:8, background:bg, border:`1px solid ${border}`, marginBottom:8, display:"flex", alignItems:"center", gap:12 });
    ...
    <div>
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:24 }}>
        <div>
          ...
          <p style={{ margin:"4px 0 0", color:"#6b7280", fontSize:14 }}>Visão geral · Março 2026</p>
        </div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 340px", gap:18, marginBottom:24 }}>
        <div style={{ background:"white", borderRadius:12, padding:"20px", border:"1px solid #e5e7eb" }}>
          <h3 style={{ margin:"0 0 16px", fontSize:14, fontWeight:600, color:"#111827" }}>Gastos por Mês</h3>
          ...
          <div style={{ display:"flex", gap:16, marginTop:8, fontSize:12, color:"#6b7280" }}>
            <span style={{ display:"flex", alignItems:"center", gap:4 }}><span style={{ width:10, height:10, borderRadius:2, background:"#e5e7eb", display:"inline-block" }} />Total</span>
            <span style={{ display:"flex", alignItems:"center", gap:4 }}><span style={{ width:10, height:10, borderRadius:2, background:"#f59e0b", display:"inline-block" }} />Pago</span>
          </div>
        </div>
        <div style={{ background:"white", borderRadius:12, padding:"20px", border:"1px solid #e5e7eb" }}>
          <h3 style={{ margin:"0 0 10px", fontSize:14, fontWeight:600, color:"#111827" }}>Por Categoria (Mar)</h3>
            ...
            return (
              <div key={e.id} style={{ ...card(bg, over?"#fecaca":today_?"#fde68a":"#bbf7d0") }}>
                <div style={{ flex:1 }}>
                  ...
                  <div style={{ fontSize:11, color:"#6b7280", marginTop:2 }}>{e.person} · {e.location} · {fmtDate(e.dueDate)}</div>
                </div>
                ...
                <button onClick={() => onMarkPaid(e.id)} style={{ padding:"6px 12px", background:"#f59e0b", color:"white", border:"none", borderRadius:6, cursor:"pointer", fontSize:11, fontWeight:700 }}>Pagar</button>
              </div>
            );
          })}
        </div>
  ...
  const filtered = useMemo(() => {
    return expenses.filter(e => {
      ...
      if (searchTerm) {
        ...
        if (!e.title.toLowerCase().includes(q) && !e.location.toLowerCase().includes(q) && !e.person.toLowerCase().includes(q)) return false;
      }
      return true;
...
// ─── ALERTS VIEW ──────────────────────────────────────────────────────────────
const AlertsView = ({ expenses, onMarkPaid, onEdit }) => {
  const overdue  = expenses.filter(e => e.status==="overdue" || (e.status!=="paid" && getDays(e.dueDate)<0));
  const dueToday = expenses.filter(e => e.status!=="paid" && e.status!=="overdue" && getDays(e.dueDate)===0);
  const dueSoon  = expenses.filter(e => e.status==="pending" && getDays(e.dueDate)>0 && getDays(e.dueDate)<=7);
  const upcoming = expenses.filter(e => e.status==="pending" && getDays(e.dueDate)>7 && getDays(e.dueDate)<=30);
...
// ─── CATEGORIES VIEW ──────────────────────────────────────────────────────────
const CategoriesView = ({ categories, setCategories, expenses, useRemote, apiBase }) => {
    ...
    if (useRemote) {
      try {
        ...
        if (!res.ok) {
          ...
          return alert(err.message || "Não foi possível criar a categoria.");
        }
        const c = await res.json();
        setCategories((prev) => [...prev, { id: c.id, name: c.name, color: c.color, icon: c.icon || "📦" }]);
      } catch {
        alert("Erro de rede ao criar categoria.");
      }
    } else {
      setCategories((prev) => [...prev, { id: Date.now(), name: name.trim(), color, icon }]);
    }
    setName(""); setColor("#6b7280"); setIcon("📦");
  };
  const removeCat = async (n) => {
    if (expenses.some((e) => e.category === n)) return alert("Categoria em uso — remova os gastos primeiro.");
    const row = categories.find((c) => c.name === n);
    if (useRemote && row?.id) {
      try {
        const res = await fetch(`${apiBase}/categories/${row.id}`, { method: "DELETE", headers: { Accept: "application/json" } });
        if (!res.ok) {
          const err = await res.json().catch(() => ({}));
          return alert(err.message || "Não foi possível remover.");
        }
      } catch {
        return alert("Erro de rede ao remover categoria.");
      }
    }
    setCategories((prev) => prev.filter((c) => c.name !== n));
  };
    ...
    <div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill, minmax(190px, 1fr))", gap:12 }}>
        {categories.map(c => {
          ...
          return (
            <div key={c.name} style={{ background:"white", border:"1px solid #e5e7eb", borderRadius:12, padding:16, position:"relative", overflow:"hidden" }}>
              ...
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:10 }}>
                ...
                {count===0 && (
                  <button onClick={() => removeCat(c.name)} style={{ background:"none", border:"none", cursor:"pointer", color:"#d1d5db", padding:2 }}><X size={12} /></button>
                )}
              </div>
...
// ─── PEOPLE VIEW ──────────────────────────────────────────────────────────────
const PeopleView = ({ people, setPeople, expenses, useRemote, apiBase }) => {
  const [name, setName] = useState("");
  ...
  const add = async () => {
    ...
    if (!trimmed || people.some((p) => personName(p) === trimmed)) return;
    if (useRemote) {
      try {
        ...
        if (!res.ok) {
          const err = await res.json().catch(() => ({}));
          return alert(err.message || "Não foi possível adicionar a pessoa.");
        }
        const row = await res.json();
        setPeople((prev) => [...prev, { id: row.id, name: row.name }]);
      } catch {
        alert("Erro de rede ao adicionar pessoa.");
      }
    } else {
  ...
  const remove = async (p) => {
    ...
    if (expenses.some((e) => e.person === pname)) return alert("Pessoa com gastos — não pode ser removida.");
    if (useRemote && pid) {
      try {
        const res = await fetch(`${apiBase}/people/${pid}`, { method: "DELETE", headers: { Accept: "application/json" } });
        if (!res.ok) {
          const err = await res.json().catch(() => ({}));
          return alert(err.message || "Não foi possível remover.");
        }
      } catch {
        return alert("Erro de rede ao remover pessoa.");
      }
    }
    setPeople((prev) => prev.filter((x) => personName(x) !== pname));
  };
    ...
    <div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill, minmax(220px, 1fr))", gap:16 }}>
        {people.map((p,i) => {
          ...
          const all   = expenses.filter(e => e.person===pname);
          ...
          const init  = pname.split(" ").map(n=>n[0]).join("").slice(0,2).toUpperCase();
          return (
            <div key={pname} style={{ background:"white", border:"1px solid #e5e7eb", borderRadius:14, padding:20 }}>
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:14 }}>
                <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                  ...
                  <div>
                    <div style={{ fontWeight:700, fontSize:15, color:"#111827" }}>{pname}</div>
                    <div style={{ fontSize:12, color:"#9ca3af" }}>{all.length} gastos</div>
                  </div>
                </div>
                {all.length===0 && <button onClick={()=>remove(p)} style={{ background:"none", border:"none", cursor:"pointer", color:"#d1d5db" }} type="button"><Trash2 size={14} /></button>}
              </div>
...
export default function App() {
  ...
  const [expenses,   setExpenses]   = useState(INIT_EXPENSES_SEED);
  ...
  // Filter state (lifted so Expenses view retains state while navigating)
  const [fMonth,  setFMonth]  = useState("2026-03");
  ...
  const refreshFromApi = useCallback(async () => {
    const [expRes, catRes, peRes] = await Promise.all([
      fetch(`${API_BASE}/expenses?per_page=500`, { headers: { Accept: "application/json" } }),
      fetch(`${API_BASE}/categories`, { headers: { Accept: "application/json" } }),
      fetch(`${API_BASE}/people`, { headers: { Accept: "application/json" } }),
    ]);
    if (!expRes.ok || !catRes.ok || !peRes.ok) throw new Error("HTTP");
    const expJson = await expRes.json();
    const catJson = await catRes.json();
    const peJson = await peRes.json();
    const list = expJson.data ?? expJson;
    setExpenses(Array.isArray(list) ? list.map(mapExpenseFromApi) : []);
    setCategories(
      catJson.map((c) => ({ id: c.id, name: c.name, color: c.color || "#6b7280", icon: c.icon || "📦" })),
    );
    setPeople(peJson.map((p) => ({ id: p.id, name: p.name })));
    setUseRemote(true);
    setLoadHint(null);
  }, []);
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) {
          setExpenses(INIT_EXPENSES_SEED);
          setCategories(INITIAL_CATEGORIES);
          setPeople(INITIAL_PEOPLE);
          setUseRemote(false);
          setLoadHint("API indisponível — exibindo dados locais (demo).");
        }
      } finally {
  ...
  const alertCount = useMemo(() =>
    expenses.filter(e => e.status!=="paid" && getDays(e.dueDate)<=7).length,
  [expenses]);
  ...
  const onSave   = async (d) => {
    if (!useRemote) {
      setExpenses((prev) => (d.id ? prev.map((e) => (e.id === d.id ? d : e)) : [...prev, { ...d, id: Date.now() }]));
      setModal(false);
      return;
    }
    try {
      const payload = buildExpensePayload(d);
      const isEdit = Boolean(d.id);
      const url = isEdit ? `${API_BASE}/expenses/${d.id}` : `${API_BASE}/expenses`;
      ...
      if (!res.ok) {
        const err = await res.json().catch(() => ({}));
        return alert(err.message || "Não foi possível salvar o gasto.");
      }
      const saved = await res.json();
      const row = mapExpenseFromApi(saved);
      setExpenses((prev) => (isEdit ? prev.map((e) => (e.id === row.id ? row : e)) : [...prev, row]));
      setModal(false);
    } catch {
      alert("Erro de rede ao salvar o gasto.");
    }
  };
  const onDelete = async (id) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/expenses/${id}`, { method: "DELETE", headers: { Accept: "application/json" } });
      if (!res.ok) {
        const err = await res.json().catch(() => ({}));
        return alert(err.message || "Não foi possível excluir.");
      }
      setExpenses((prev) => prev.filter((e) => e.id !== id));
    } catch {
  ...
  const onPaid   = async (id) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/expenses/${id}/pay`, { method: "PATCH", headers: { Accept: "application/json" } });
      if (!res.ok) {
        const err = await res.json().catch(() => ({}));
        return alert(err.message || "Não foi possível marcar como pago.");
      }
      const saved = await res.json();
      const row = mapExpenseFromApi(saved);
  ...
  return (
    <div style={{ display:"flex", height:"100vh", background:"#f8fafc", fontFamily:"'Segoe UI', system-ui, sans-serif", position:"relative", overflow:"hidden" }}>
      <Sidebar view={view} setView={setView} alertCount={alertCount} />
      <main style={{ flex:1, overflowY:"auto", padding:"28px 32px" }}>
        ...
        {loading ? (
          <div style={{ padding:40, textAlign:"center", color:"#6b7280", fontSize:14 }}>Carregando…</div>
        ) : (
          <>
            {view==="dashboard"  && <DashboardView  expenses={expenses} categories={categories} onAdd={openAdd} onEdit={openEdit} onMarkPaid={onPaid} />}
            {view==="expenses"   && <ExpensesView   expenses={expenses} categories={categories} people={people} onEdit={openEdit} onDelete={onDelete} onMarkPaid={onPaid} onAdd={openAdd} filterMonth={fMonth} setFilterMonth={setFMonth} filterCategory={fCat} setFilterCategory={setFCat} filterPerson={fPerson} setFilterPerson={setFPerson} filterStatus={fStatus} setFilterStatus={setFStatus} searchTerm={fSearch} setSearchTerm={setFSearch} />}
            {view==="alerts"     && <AlertsView     expenses={expenses} onMarkPaid={onPaid} onEdit={openEdit} />}
            {view==="categories" && <CategoriesView categories={categories} setCategories={setCategories} expenses={expenses} useRemote={useRemote} apiBase={API_BASE} />}
            {view==="people"     && <PeopleView     people={people} setPeople={setPeople} expenses={expenses} useRemote={useRemote} apiBase={API_BASE} />}
          </>
        )}
      </main>
      {modal && (
        <ExpenseModal key={editing ? `e-${editing.id}` : "new"} expense={editing} categories={categories} people={people} onSave={onSave} onClose={() => setModal(false)} />
      )}
    </div>
  );
}
